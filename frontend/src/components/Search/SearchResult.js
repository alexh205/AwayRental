...
const SearchResult = ({
  ...
  return (
    <div className='grid grid-cols-3 pr-5 hover:opacity-75 hover:shadow-lg transition duration-200 ease-out first:border-t'>
      <div
        onClick={() => history.push(`/spots/${id}`)}
        className="flex py-5 px-2 border-r border-b cursor-pointer col-span-2">
        <div className="relative h-48 w-48 md:h-52 md:w-80 flex-shrink-0">
          <img
            src={image}
            alt="spot"
        ...
        <div className="flex flex-col flex-grow pl-5 ">
          ...
          <div className="flex justify-between items-end pt-[5px]">
