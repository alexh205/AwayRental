                ...
                <div className="flex flex-col pr-[120px]">
                  ...
                  <div className="flex justify-between">
                    <div className="font-semibold text-[21px] pb-1">
                      The {spot.type} Is Hosted by {spot.Owner?.firstName}
                    </div>
                    <div className="pr-3">
                      <User className="h-10 " />
                    </div>
                      ...
                      <>
                        <div className="flex pt-[25px]">
                          ...
                          <div>
                            ...
                            <div className="text-gray-400 text-[15px]">
                              Recent guests gave the location a high rating
                            </div>
                          </div>
                        </div>
                        <div className="flex pt-[25px]">
                          ...
                          <div>
                            ...
                            <div className="text-gray-400 text-[15px]">
                              Recent guests gave the check-in process a high
                              rating.
                            </div>
                          </div>
                        </div>{' '}
                      </>
                    ) : spot.avgRating < 2.5 && spot.avgRating >= 1 ? (
                      <div className="flex pt-[25px]">
                        <div className="pr-[20px]">
                          <LocationMarkerIcon className="h-7" />
                        </div>
                        <div>
                          ...
                          <div className="text-gray-400 text-[15px]">
                            Recent guests rate this location as "interesting".{' '}
                            <i className="text-[11px]">
                              'locations rated at a below average rating'
                            </i>
                          </div>
                        </div>
                      </div>
                      ...
                      spot.avgRating === 0 && (
                        <div className="flex pt-[25px]">
                          ...
                          <div>
                            ...
                            <div className="text-gray-400 text-[15px]">
                              Be the first to discover and review this new
                              location.
                            </div>
                          </div>
                        </div>
                    ...
                    <div>
                      ...
                      <div className="flex mb-4">
                        <div className="flex flex-col">
                          ...
                          <p>Bedroom</p>
                          <p className=" py-[3px] text-[12px]">1 queen bed</p>
                        </div>
                        <div className="flex flex-col">
                          <div></div>
                          <p>Living room</p>
                          <p className=" py-[3px] text-[12px]">1 sofa bed</p>
                        </div>
                      </div>
                    </div>
                  </div>
